...
export const _notifications = [...Array(5)].map((_, index) => ({
  ...
  description: [
    ...
    `answered to your comment on the ${process.env.REACT_APP_PROJECT_TITLE}`,
    '5 unread messages',
...
export const _socials = [
  {
    ...
    color: '#1877F2',
    path: 'https://www.facebook.com/BiggBrainsCom',
  },
  {
    value: 'instagram',
    name: 'Instagram',
    ...
    color: '#E02D69',
    path: 'https://www.instagram.com/biggbrains_com/',
  },
  {
    value: 'linkedin',
    name: 'Linkedin',
    ...
    color: '#007EBB',
    path: 'https://www.linkedin.com/company/biggbrains',
  },
  {
    value: 'twitter',
    name: 'Twitter',
    ...
    color: '#00AAEC',
    path: 'https://twitter.com/BiggBrains_com',
  },
];
