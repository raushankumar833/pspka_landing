...
export function SettingsProvider({ children }: SettingsProviderProps) {
  ...
  const [loginLayout, setLoginLayout] = useState(defaultSettings.loginLayout);
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const loginLayout = getCookie('loginLayout') || defaultSettings.loginLayout;
      ...
      setLoginLayout(loginLayout as LoginLayoutValue);
  ...
  const onChangeLoginLayout = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
    const value = event.target.value as ThemeLayoutValue;
    setLoginLayout(value);
    setCookie('loginLayout', value);
  }, []);
  ...
  const onResetSetting = useCallback(() => {
    ...
    setLoginLayout(defaultSettings.loginLayout);
    removeCookie('themeMode');
    removeCookie('themeLayout');
    removeCookie('loginLayout');
