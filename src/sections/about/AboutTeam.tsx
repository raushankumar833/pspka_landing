  ...
  return (
    <Container component={MotionViewport} sx={{ pb: 10, textAlign: 'center' }}>
      ...
      <m.div variants={varFade().inUp}>
        ...
        >
          {process.env.REACT_APP_PROJECT_TITLE} will provide you support if you have any problems,
          our support team will reply within a day and we also have detailed documentation.
        </Typography>
      </m.div>
