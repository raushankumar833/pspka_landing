...
export default function MakeCreditReqDialogue({ refresh }: any) {
  ...
  const disabledDate = (date: any) => new Date(date) > new Date();
  ...
  const onSubmit = async (data: any) => {
    data.date = ddmmyyyy(selectedDate);
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={12}>
                ...
                >
                  ...
                  <p style={{ color: "green", marginTop:"-6%" }}>{amountInWords}</p>
                  <DatePicker
                    style={{ width: isMobile ? '200px' : '180px' }}
