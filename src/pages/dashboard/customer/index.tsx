...
// import Marquee from 'src/sections/@dashboard/general/app/Marquee';
...
export default function GeneralAppPage() {
  ...
  if (wallet && wallet.walletType === 'dual') {
    _bankingCreditCard.push({
      id: _mock.id(3),
      balance: wallet?.w2,
      cardType: 'Wallet 2',
  ...
  return (
    <RoleBasedGuard hasContent roles={[USERROLES.retailer, USERROLES.admin, USERROLES.ad]}>
      <Head>
      ...
      <Container maxWidth={themeStretch ? false : 'xl'}>
        <Grid container spacing={3}>
          <Grid item xs={12} md={8}>
            ...
            {/* <Marquee text="This is a scrolling text using Material-UI and CSS animations." />   */}
            <AppWelcome
              title={`Welcome back! \n ${user?.name}`}
